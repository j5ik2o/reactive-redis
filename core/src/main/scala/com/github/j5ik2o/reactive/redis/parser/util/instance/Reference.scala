package com.github.j5ik2o.reactive.redis.parser.util.instance

import com.github.j5ik2o.reactive.redis.parser.util.instance.ReferenceTypes.{ ParseState, Parser }
import com.github.j5ik2o.reactive.redis.parser.util.{ Location, ParseError, Parsers }
...
object ReferenceTypes {
  ...
  final case class Success[+A](get: A, length: Int)               extends Result[A]
  final case class Failure(get: ParseError, isCommitted: Boolean) extends Result[Nothing]
